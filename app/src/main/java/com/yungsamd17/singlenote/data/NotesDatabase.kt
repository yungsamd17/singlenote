...
// Schema export stays off until the baseline JSON can be generated by a
// real build: with exportSchema=true, debug and release KSP share one
// schema dir and race (release reads an empty 2.json → "Empty schema
// file"). The room.schemaLocation arg in app/build.gradle.kts is already
// in place, so flipping this back on is a one-line change once
// app/schemas/2.json is generated and committed.
